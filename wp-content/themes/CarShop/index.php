				...
				<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
					<div class="carousel-inner" role="listbox">
				    	...
				    	<div class="carousel-item active">
				      		<a href=""><img style="width: 100%" class="d-block img-fluid animated zoomIn " src="<?php bloginfo('template_directory');?>/img/bg_footer.jpg" alt="First slide"></a>
				...
				<div class="row">
					<div class="col-lg-4 item-intro">
						<div class="img-height">
							<a href=""><img src="<?php bloginfo('template_directory');?>/img/icon1.png" alt=""></a>
						</div>
						<div class="item-info">
